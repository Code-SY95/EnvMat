...
def generate(
    ...
    ### Sy: Exclude what we didn't learn in this study
    # sketch = (
...
def run_generation(
    ...
    control["image_embed"] = process_image(render_emb, image_resolution, model.device) # Sy: render_emb is PIL render image. And  control["image_embed"] shape is [1, 3, h, w].
    control["text"] = prompt
