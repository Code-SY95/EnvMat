...
class Rendering():
    ...
    def render(self, number): # Sy: number = rendering 할 env map 갯수
        for i in tqdm(range(self.pbr_length)):
            ...
            # if (len(check_renders) == number) or (len(check_renders) == number*2):
            #     continue
            ...
            for env_chunk in env_chunks:
                ...
                dir1, dir2 = self.render_env(folder, pbrmap, envmap_img1, env_name1, devices[0]), \
                                    self.render_env(folder, pbrmap, envmap_img2, env_name2, devices[1]), # Sy: 
                common = dir1.parent
                # d1, d2, d3 = dir1.stem, dir2.stem, dir3.stem
                d1, d2 = dir1.stem, dir2.stem
                
                # print(f"{common}, {d1}, {d2}, {d3}")
                print(f"{common}, {d1}, {d2}")
...
if __name__ == "__main__":
    ...
    root = Path('/mnt/1TB/MatGen/data/maps')
